  ...
  render() {
    return (
      <ul className="payment">
        ...
        <li className="white" id="bottom">$200 (sliding scale available)</li>
        <br/>
        ...
        <li className="white">Cash</li>
          ...
          <li className="white" id="bottom">Venmo</li>
          </Col>
          <Col xs={12} sm={6}>
        <li id="officeInfoHead" className="white">
        ...
        <li className="white">BlueCross/BlueShield</li>
          ...
          <li className="white" id="bottom">Out of Network Providers</li>
          </Col>
          </Row>
      </ul>
    );
